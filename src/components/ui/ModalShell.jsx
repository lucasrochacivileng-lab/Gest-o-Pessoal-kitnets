...
export default function ModalShell({ title, subtitle, onClose, maxWidth = 'max-w-2xl', children }) {
  return (
    <div className="fixed inset-0 z-[70] flex items-end justify-center bg-slate-950/45 sm:items-center sm:p-4">
      <div className={`max-h-[calc(100dvh-env(safe-area-inset-top))] w-full ${maxWidth} overflow-y-auto rounded-t-2xl bg-white px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4 shadow-2xl sm:max-h-[90vh] sm:rounded-2xl sm:p-5`}>
