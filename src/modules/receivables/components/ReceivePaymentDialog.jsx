...
export function ReceivePaymentDialog({ receivable, contracts, kitnets, tenants, onSubmit, onClose }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4">
      <div className="max-h-[90vh] w-full max-w-5xl overflow-y-auto rounded-3xl bg-white p-4 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-slate-900">Receber aluguel</h2>
            <p className="text-sm text-slate-500">Confirme o pagamento e registre os detalhes.</p>
          </div>
        ...
        <ReceivableForm receivable={receivable} contracts={contracts} kitnets={kitnets} tenants={tenants} onSubmit={onSubmit} onCancel={onClose} />
      </div>
    </div>
  );
}
