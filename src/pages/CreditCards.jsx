...
export default function CreditCards() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="ds-card">
        <div>
          <h2 className="text-base font-semibold text-slate-900">Configurar importação</h2>
          <p className="mt-1 text-sm text-slate-500">CSV ou Excel com parcelas futuras geradas automaticamente.</p>
          {invoiceHeadline ? (
